...
#find . -name "mr-out*" -print0 | xargs -0 sort > mr-indexer-all
#find . -name "mr-out*" -print0 | sort | grep . > mr-indexer-all
cd /Users/bytedance/mit6824/6.5840/src/main/mr-tmp
/usr/bin/sort mr-out* | grep . > mr-indexer-all
